...
const REPORTS_LOCAL = 'https://172.16.28.181:4173/3danalytics-reports/#/panel';

// const isDev = import.meta.env.DEV;
const REPORTS_BASE = REPORTS_LOCAL;
...
for (const [parentId, children] of childMap) {
  ...
  children.sort((a, b) => {
    ...
    if (parent?.semantic.detailLevel === 0)
      return pa.semantic.processStep - pb.semantic.processStep;
